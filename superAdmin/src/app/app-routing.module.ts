...
const routes: Routes = [
  ...
  { path: 'admin-detalle-negocio', loadChildren: './admin-detalle-negocio/admin-detalle-negocio.module#AdminDetalleNegocioPageModule',canActivate: [AutGuardGuard] },
  ...
  { path: 'admin-actualizar-negocio', loadChildren: './admin-actualizar-negocio/admin-actualizar-negocio.module#AdminActualizarNegocioPageModule',canActivate: [AutGuardGuard] }
